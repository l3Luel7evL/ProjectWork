				...
				<tbody>
					<c:forEach items="${academies}" var="academy">
						<tr>
							...
							<td>
								<spring:url value="/academies/update/${academy.code}" var="editURL"/>
							...
							<td>
								<spring:url value="/academies/remove/${academy.code}" var="deleteURL"/>
							...
							<td>
								<spring:url value="/students/${academy.code}" var="studentsURL"/>
								<a class="btn" style="background-color: gold; color: white;" href="${studentsURL}" role="button">
